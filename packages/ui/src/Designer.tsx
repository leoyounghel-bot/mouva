...
class Designer extends BaseUIClass {
  ...
  private onSelectionChangeCallback?: (schemas: SchemaForUI[]) => void;
  ...
  public onSelectionChange(cb: (schemas: SchemaForUI[]) => void) {
    ...
    ReactDOM.render(
      ...
      >
        <DesignerComponent
          ...
          onSelectionChange={(schemas: SchemaForUI[]) => {
            if (this.onSelectionChangeCallback) {
              this.onSelectionChangeCallback(schemas);
            }
          }}
          size={this.size}
        />
