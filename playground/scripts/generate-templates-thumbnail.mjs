...
// import { pdf2img } from '@pdfme/converter/cjs/src/index.node.js'; // Dynamic import used instead
...
async function createThumbnailFromTemplate(templatePath, thumbnailPath) {
  let pdf2img;
  try {
     const module = await import('@pdfme/converter/cjs/src/index.node.js');
     pdf2img = module.pdf2img;
  } catch (e) {
    console.warn('Canvas not found or pdf2img import failed. Skipping thumbnail generation for ' + templatePath);
    return;
  }
